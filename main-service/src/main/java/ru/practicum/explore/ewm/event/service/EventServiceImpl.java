...
import ru.practicum.explore.ewm.category.model.Category;
import ru.practicum.explore.ewm.category.CategoryRepository;
import ru.practicum.explore.ewm.event.EventMapper;
import ru.practicum.explore.ewm.event.EventRepository;
import ru.practicum.explore.ewm.event.EventValidator;
import ru.practicum.explore.ewm.event.model.Event;
import ru.practicum.explore.ewm.event.model.EventState;
import ru.practicum.explore.ewm.event.dto.request.NewEventDto;
import ru.practicum.explore.ewm.event.dto.request.UpdateEventAdminRequest;
import ru.practicum.explore.ewm.event.dto.request.UpdateEventUserRequest;
import ru.practicum.explore.ewm.event.dto.response.EventFullDto;
import ru.practicum.explore.ewm.event.dto.response.EventShortDto;
import ru.practicum.explore.ewm.exception.ConflictException;
import ru.practicum.explore.ewm.exception.EntityNotFoundException;
import ru.practicum.explore.ewm.exception.ForbiddenException;
