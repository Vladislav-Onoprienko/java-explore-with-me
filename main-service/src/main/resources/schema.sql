...
CREATE TABLE IF NOT EXISTS comments (
    ...
    CONSTRAINT chk_comment_status CHECK (status IN ('PENDING', 'PUBLISHED', 'REJECTED', 'DELETED'))
);
...
CREATE TABLE IF NOT EXISTS comment_moderations (
    ...
    created_on TIMESTAMP WITHOUT TIME ZONE NOT NULL,
    CONSTRAINT pk_comment_moderation PRIMARY KEY (id),
    ...
    CONSTRAINT chk_moderation_action CHECK (action IN ('APPROVED', 'REJECTED'))
);
